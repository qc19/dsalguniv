...
int main()
{
    ...
    printf("[memoization] The Length of Longest Palindromic Subsequence is : %d \r\n", len);

    len = longestPalindromeSubsequence(s, TABULATION);
    printf("[tabulation] The Length of Longest Palindromic Subsequence is : %d \r\n", len);

    len = longestPalindromeSubsequence(s, OPTIMIZED);
    printf("[optimized] The Length of Longest Palindromic Subsequence is : %d \r\n", len);
}