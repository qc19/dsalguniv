...
void
add2buff (buff_t *buff, int d, int k)
{
    if (buff->sz == 0) {
        buff->sz = 10;
...
void
bt (int *cand, int sz, int target, int start, int d, buff_t *buff, res_t *res)
{
    int i;
...
int **
combinationSum2 (int *candidates, int candidatesSize, int target, int **columnSizes, int *returnSize)
{
    res_t res = { 0 };
    buff_t buff = { 0 };
...
void
input (int *candidates, int candidatesSize, int target, int *returnSize, int **returnColumnSizes,
...
int **
combinationSum2 (int *candidates, int candidatesSize, int target, int *returnSize, int **returnColumnSizes)
{
