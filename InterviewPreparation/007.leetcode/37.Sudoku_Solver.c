static bool
isNumInRow (char **board, int size, char number, int row)
{
...
static bool
isNumInCol (char **board, int size, char number, int col)
{
    for (int i = 0; i < size; i++)
...
static bool
isNumInSubBox (char **board, int size, char number, int row, int col)
{
...
static bool
canPlaceNum (char **board, int size, char number, int row, int col)
{
